...
# The codebase is specified to be in /tmp/tmpadblcyl2/
echo "Navigating to /tmp/tmpadblcyl2/"
cd /tmp/tmpadblcyl2/

# Check if the directory change was successful
if [ $? -ne 0 ]; then
  echo "Error: Failed to change directory to /tmp/tmpadblcyl2/. Please ensure the codebase is at this path."
  exit 1
fi
